...
export default function ProductHeroSection() {
  ...
  const isInView = useInView(dashRef, { once: false, margin: "-10% 0px" });
      ...
      <div className="grid items-start gap-10 xl:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)] xl:gap-16 2xl:gap-20">
        ...
        <div ref={dashRef} className="relative xl:pl-4 2xl:pl-8">
          <motion.div
            ...
            transition={{ duration: 0.7, delay: isInView ? 0.15 : 0, ease: [0.16, 1, 0.3, 1] }}
            className="relative"
          >
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <div className="rounded-2xl border border-zinc-800 bg-zinc-800/70 p-4 sm:p-5 mb-4 sm:mb-5 overflow-hidden relative">
                    <motion.div
                      ...
                      animate={isInView ? { x: ["0%", "360%"] } : { x: "0%", opacity: 0 }}
                      transition={isInView ? { duration: 2.8, repeat: Infinity, ease: "linear" } : { duration: 0.4 }}
                    />
                    <div className="flex items-start justify-between gap-4 relative">
                      ...
                      <span className="rounded-md bg-amber-400/10 px-2.5 py-1 text-[10px] uppercase tracking-[0.18em] text-amber-400">
                        24/7
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-2 sm:gap-4 mb-4 sm:mb-5">
                    <div className="bg-zinc-800 rounded-lg sm:rounded-xl p-3 sm:p-4">
                      ...
                      <p className="text-amber-400 text-[10px] sm:text-xs mt-1">
                        +12 esta semana
                      </p>
                    </div>
                    <div className="bg-zinc-800 rounded-lg sm:rounded-xl p-3 sm:p-4">
                    ...
                    <div className="h-32 sm:h-40 flex items-end gap-1.5">
                      {barHeights.map((height, index) => (
                        <motion.div
                          ...
                          transition={{
                            duration: isInView ? 0.55 : 0.3,
                            delay: isInView ? 0.25 + index * 0.03 : 0,
                            ease: [0.16, 1, 0.3, 1],
                          }}
                          style={{ height: `${height}%` }}
                        />
                  ...
                  <div className="bg-zinc-800 rounded-lg sm:rounded-xl p-3 sm:p-4 flex items-center justify-between gap-3">
                    <div className="flex items-center gap-2 sm:gap-3">
                      <div className="w-6 h-6 sm:w-8 sm:h-8 bg-amber-400/10 rounded-full flex items-center justify-center">
                    ...
                    <span className="text-amber-400 text-[10px] sm:text-xs font-medium bg-amber-400/10 px-2 sm:px-3 py-1 rounded-md">
                      Seguro
                    </span>
                  </div>
                </div>
